<?php
	...
	if ($consulta[0]=1)
	{
		$agre="INSERT INTO `MATEMATICASIV`(`UNIDAD`,`PREGUNTA`,`RESPUESTA_correcta`,`RESPUESTA_uno`,`RESPUESTA_dos`,`RESPUESTA_tres`) VALUES('$consulta[1]','$consulta[2]','$consulta[3]','$consulta[4]','$consulta[5]','$consulta[6]');";
	}
	else
	{
