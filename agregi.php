<?php
	...
	if($consulta[0])
			$i=($consulta[0])-1;
			$agre="INSERT INTO  $asignaturas[$i]	(`UNIDAD`,`PREGUNTA`,`RESPUESTA_correcta`,`RESPUESTA_uno`,`RESPUESTA_dos`,`RESPUESTA_tres`) VALUES('$consulta[1]','$consulta[2]','$consulta[3]','$consulta[4]','$consulta[5]','$consulta[6]');";
